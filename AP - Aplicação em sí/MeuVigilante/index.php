...
<section id="telaDelogin">
    <div id="avisoDeAnonimato">
            <div>
                ...
                <h1>Você está entrando no modo anônimo</h1>
                <p>Nós entendemos o seu desconforto, nessa opção a prioridade é a segurança</p>
    ...
    <form name="formularioDeLogin" method="post" action="index.php">
        ...
        <p><button type="button" class="btn btn-secondary" onclick="carregarPaginaDe('Cadastro')">Cadastrar-se</button></p>
        <p><button type="button" class="btn btn-dark" onclick="avisarSobreOAnonimato()">Entrar como Anônimo</button></p>
        <p><button type="button" class="btn btn-secondary" onclick="sair()">Sair</button></p>
    </form>
</section>
...
<section id="telaDeCadastro">
    ...
    <form name="formularioDeCadastro" method="post" action="index.php">
        ...
        <p><button type="submit" class="btn btn-primary" id="btnCadastrar">Cadastrar</button></p>
        <p><button type="button" class="btn btn-secondary" onclick="carregarPaginaDe('Login')">Voltar</button></p>
    </form>
</section>
...
<section id="telaPrincipal">
    <ul>
        <li><button class="btn btn-danger" onclick="iniciarDenuncia()">Efetuar Denuncia</button></li>
        <li><button class="btn btn-primary" onclick="consultarAsMinhasDenuncias()">Consultar as minhas denuncias</button></li>
